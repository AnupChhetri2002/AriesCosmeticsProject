        ...
        <div className="h-full w-full ">
          <div className="w-full flex justify-center flex-col">
            <div className="w-full flex justify-center">
              <h1 className="text-7xl font-logo3 text-[#EADFB4]">
                OUR SALON
              </h1>
            </div>
            <div className="h-full w-full mt-9">
              <h1 className="text-xl  font-logo text-[#9BB0C1] items-center justify-center pl-3">
              Welcome to Salon Beni!  After being greeted by our friendly staff, we invite you to enjoy our complimentary beverages and home made snacks and relax in our fireplace seating area. 
              </h1>
            </div>
            <div className="h-full w-full mt-9">
              <h1 className="text-xl  font-logo text-[#9BB0C1] items-center justify-center pl-3">
              Our team takes part in ongoing continuing education. We build a foundation by dedicating one night each week to provide our apprentices with hands-on learning to develop their craft.               </h1>
            </div>
            <div className="h-full w-full mt-9">
              <h1 className="text-xl  font-logo text-[#9BB0C1] items-center justify-center pl-3">
              We continue stylist education through in-salon  programs including color formulating, cutting, and motivational speaking. In addition, our staff frequently trains with the premier hair stylists and product companies worldwide.              </h1>
            </div>
          </div>
        </div>
