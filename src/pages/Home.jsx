        ...
        >
          ...
          <SwiperSlide>
            ...
            <div className="mt-[-20rem]  ">
              <h1 className="px-4  mini:text-7xl mobile:text-5xl text-xl font-bold text-[#F3F8FF]">
                Aeries <span className="text-[#b0b0b0]"> Cosmetics</span>
              </h1>
              <h1 className="px-4  mini:text-7xl mobile:text-5xl text-xl font-bold text-[#F3F8FF]">
          ...
          <SwiperSlide>
            ...
            <div className="mt-[-20rem] text-left pl-9  ">
              <h1 className="px-4  mini:text-7xl mobile:text-5xl text-xl font-bold text-[#F3F8FF]">
                Aeries <span className="text-[#a44ae0]"> Cosmetics</span>
              </h1>
              <h1 className="px-4  mini:text-7xl mobile:text-5xl text-xl font-bold text-[#F3F8FF]">
          ...
          <SwiperSlide>
            <img
              ...
              alt="background4"
            />
            <div className="mt-[-20rem "><h1 className="px-4  mini:text-7xl mobile:text-5xl text-xl font-bold text-[#151e2c]">
            Aeries <span className="text-[#5e38aa]"> Cosmetics</span>
          </h1>
          <h1 className="px-4  mini:text-7xl mobile:text-5xl text-xl font-bold text-[#253b65]">
            Shop<span className="text-[#d84256]"> Fast</span>
          </h1>
          <button className=" mini:w-52  ml-2 mt-9 bg-[#e2e6ca] hover:bg-black hover:text-white text-[#13070f] text-[12px] py-1 px-2 transition-all duration-300 ease-in-out  mini:text-4xl mobile:text-3xl mobile:w-40 w-[6rem]">
            Shop Now
          </button>
        </div>
          </SwiperSlide>
